...
IMG_PATH = r"D:\fgo_bot\logs\screen.png" # 暫存截圖路徑 
TEMPLATE_DIR = r"D:\fgo_bot\logs\temp_cards" # 裁切後的卡片存放處 
ATTACK_TEMPLATE = r"D:\fgo_bot\logs\attack.png" # Attack 按鈕模板 [cite: 1, 2]
BATTLE_DIR = r"D:\fgo_bot\logs\battle" # 回合數辨識模板資料夾 [cite: 1, 2]
...
def run_crop():
    """執行外部指令裁切 5 張指令卡 """
    subprocess.run([VENV_PY, r"D:\fgo_bot\modules\auto_crop_cards.py"])

def run_classify():
    """執行外部指令分類卡片顏色 (R/B/G) """
    subprocess.run([VENV_PY, r"D:\fgo_bot\modules\classify_cards.py"])
